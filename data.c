...
fix_t *decreasin(fix_t *head, int week, int year, char *indicator){
    ...
    do{
        ...
        if((aux1->var->cumulative_cases > aux2->var->cumulative_cases && strcmp(indicator, "cases") == 0) || (aux1->var->cumulative_deaths > aux2->var->cumulative_deaths && strcmp(indicator, "deaths") == 0)){
            aux1 = aux2;
            aux2 = aux2->next;
        }else{
            if((((aux1->var->cumulative_cases == aux2->var->cumulative_cases) && (strcmp(indicator, "cases") == 0)) || ((aux1->var->cumulative_deaths == aux2->var->cumulative_deaths) && (strcmp(indicator, "deaths") == 0))) && high_or_low(aux1->country, aux2->country) == 1){
                aux1 = aux2;
                aux2 = aux2->next;
            }else{
                aux1->next = aux2->next;
